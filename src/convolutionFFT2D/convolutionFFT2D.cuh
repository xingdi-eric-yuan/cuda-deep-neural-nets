...
__global__ void modulateAndNormalize_kernel(
    fComplex *d_Dst, fComplex *d_Src, int dataSize, float c){
...
__global__ void spPostprocess2D_kernel(
    fComplex *d_Dst, fComplex *d_Src, uint DY, uint DX,
...
__global__ void spProcess2D_kernel(
    fComplex *d_Dst, fComplex *d_SrcA, fComplex *d_SrcB, uint DY, uint DX,

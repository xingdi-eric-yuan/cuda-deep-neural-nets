...
vector3f* multiply(const vector3f*, float);
vector3f* multiply(const vector3f*, const vector3f*);
Mat* multiply(const Mat*, float);
Mat* multiply(const Mat*, const vector3f*);

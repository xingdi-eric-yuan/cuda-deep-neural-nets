...
__global__ void cu_minMaxLoc(const float*, float*, float*, int*, int*, float*, float*, int*, int*, const int);
__global__ void cu_minMaxLoc1(const float*, float*, float*, int*, int*, const int);
